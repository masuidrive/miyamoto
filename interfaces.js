...
function testStorageInterface() {
  ...
  Logger.log(results.length == 1 && results[0] == 'TEST1:A');

  storageInterface.fireEvent('test2', 'B');
  Logger.log(results.length == 2 && results[0] == 'TEST1:A' && results[1] == 'TEST2:B');

  storageInterface.fireEvent('test1', 'C');
  Logger.log(results.length == 3 && results[0] == 'TEST1:A' && results[1] == 'TEST2:B' && results[2] == 'TEST1:C');
}
